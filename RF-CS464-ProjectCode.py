...
#Below is the parameter grid used to find the best parameters for Random Forest
#Using the parameter grid below will probably take a long time to run
'''
param_grid = {
...
print("\nPerforming GridSearchCV to find the best Random Forest model...")
rf = RandomForestClassifier(random_state=0, n_jobs=-1)
grid_search = GridSearchCV(rf, param_grid, scoring='f1_weighted', n_jobs=-1)
